...
/**
 * Get Header settings from Strapi
 * @returns {Promise} - Header settings data
 */
export async function getHeaderSetting() {
  try {
    // Adjust the endpoint based on your Strapi content type structure
    // Common patterns: /header-setting, /header-settings, /setting
    const data = await fetchAPI("/header-setting?populate=*");
...
export async function getServices() {
  try {
    // Adjust the endpoint based on your Strapi content type structure
    // Common patterns: /services, /service
...
/**
 * Get Portfolio from Strapi
 * @returns {Promise} - Portfolio data
 */
export async function getPortfolio() {
  try {
    // Adjust the endpoint based on your Strapi content type structure
    // Common patterns: /portfolio, /portfolio-item
...
/**
 * Get WhyChooseUs from Strapi
 * @returns {Promise} - WhyChooseUs data
 */
export async function getWhyChooseUs() {
  try {
    // Adjust the endpoint based on your Strapi content type structure
    // Common patterns: /why-choose-us, /why-choose-us-item
    const data = await fetchAPI(
      "/why-choose-us?populate[0]=whyChooseUs.list&populate[1]=whyChooseUs.image"
    );
    // Return the data based on Strapi's response structure
    // For single type: data.data
    // For collection type: data.data[0] or data.data
...
/**
 * Get Testimonial from Strapi
 * @returns {Promise} - Testimonial data
 */
export async function getTestimonial() {
  try {
    // Adjust the endpoint based on your Strapi content type structure
    // Common patterns: /testimonial, /testimonial-item
...
/**
 * Create a Contact in Strapi
 * @param {Object} contactData - Contact data to be created
